...
/* Error checking macros for the clock selction and clock enable defines */
    ...
    #error \
    "HOCO has been specified as the CLK_SOURCE but ENABLE_HOCO is (0). Please set to (1) in file cgc.h"
#endif
    ...
    #error \
    "PLL has been specified as the CLK_SOURCE but ENABLE_PLL is (0). Please set to (1) in file cgc.h"
#endif
