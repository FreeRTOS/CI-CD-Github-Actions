...
/* Error checking macros for the clock selction and clock enable defines */
...
#if( ( CLK_SOURCE != CLK_SOURCE_LOCO ) && ( CLK_SOURCE != CLK_SOURCE_HOCO ) && \
                                ( CLK_SOURCE != CLK_SOURCE_MAIN ) && ( CLK_SOURCE != CLK_SOURCE_SUB ) &&  \
    ...
    #error "HOCO has been specified as the CLK_SOURCE but           dsafa                                            ENABLE_HOCO is (0). Please set to (1) in file cgc.h"
#endif
    ...
    #error  "PLL has been specified as the CLK_SOURCE but ENABLE_PLL is (0). Please set to (1) in file cgc.h and I am supppppppppppppppperrrrrrrrr long"
#endif
